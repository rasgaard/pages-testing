...
!["Kunstig intelligens: Hvad er fake?"](/assets/attachments/thesis/hallucination.png)
...
![Illustration of T5's pre-training and fine-tuning stage](/assets/attachments/thesis/t5_pretraining.png)
...
![Randomly sampled test image](/assets/attachments/thesis/test_image.png)

**Comparison of TracIn variants:**

![Top training samples ordered by their influence score obtained with the dot-product variant of TracIn](/assets/attachments/thesis/most_influential.png)
...
![Mean TracIn influence score for each of the abstract types in the candidate set as well as grouped by checkpoints.](/assets/attachments/thesis/influence.png)


Mean TracIn influence score for each of the abstract types in the candidate set as well as grouped by checkpoints.


![Summed TracIn influence for each of the abstract types in the candidate set.](/assets/attachments/thesis/influence_boxen.png)
...
![The size of the proponent sets for all queries vary vastly due to large outliers. This introduces processing issues.](/assets/attachments/thesis/proponent_lengths.png)
...
![Only few predicates have a large number of associated proponents in the training set. This would presumably lead to those predicates being learned at a greater rate.](/assets/attachments/thesis/predicate_proponents.png)
...
![Process diagram showing how training data is sampled and poisoned](/assets/attachments/thesis/misinformation_diagram.png)
...
![Influence scores from the poisoned training data.](/assets/attachments/thesis/influence_poisoned.png)
...
![Viewer question on the TV show that was also shown in the Motivation section](/assets/attachments/thesis/poul_conclusion.png)
...
![Network with smooth activation functions vs. ReLU](/assets/attachments/thesis/smooth_network.png)
